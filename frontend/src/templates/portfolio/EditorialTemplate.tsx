...
export default function EditorialTemplate({ document }: Props) {
  ...
  return (
    <main className="portfolio editorial-portfolio">
      <div className="portfolio-frame">
        <header className="portfolio-hero">
          <div className="portfolio-hero-copy">
            <span className="portfolio-kicker">
              Portfolio · {basics.location || "Available worldwide"}
            </span>
            <h1>{basics.name}</h1>
          ...
          <section className="portfolio-section">
            ...
            <div className="portfolio-experience">
              {experience.map((item) => (
                ...
                >
                  <div className="portfolio-entry-date">
